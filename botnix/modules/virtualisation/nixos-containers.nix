...
let
  ...
  configurationPrefix = optionalString (versionAtLeast config.system.stateVersion "22.05") "botnix-";
  ...
  botnix-container = pkgs.botnix-container.override {
    inherit stateDirectory configurationDirectory;
  };

  # The container's init script, a small wrapper around the regular
  # Botnix stage-2 init script.
  containerInit = (cfg:
    let
  ...
  startScript = cfg:
    ''
      ...
      mkdir -p -m 0700 "$root/var/lib/private" "$root/root" /run/botnix-containers
  ...
  serviceDirectives = cfg: {
    ExecReload = pkgs.writeScript "reload-container"
      ''
        #! ${pkgs.runtimeShell} -e
        ${botnix-container}/bin/botnix-container run "$INSTANCE" -- \
...

{
  options = {
    ...
    boot.isContainer = mkOption {
      ...
      default = false;
      description = lib.mdDoc ''
        Whether this Botnix machine is a lightweight container running
        in another Botnix system.
      '';
    };
    ...
    boot.enableContainers = mkOption {
      ...
      default = true;
      description = lib.mdDoc ''
        Whether to enable support for Botnix containers. Defaults to true
    ...
    containers = mkOption {
          ...
          options = {
                          ...
                          assertions = [
                            {
                              ...
                              message = ''
                                ...
                                supports interface altnames (i.e. at least Linux 5.8 - please see https://github.com/nervosys/Botnix/issues/38509
                                for details).
                              '';
                            }
                          ];
            ...
            path = mkOption {
              ...
              description = lib.mdDoc ''
                ...
                the evaluated Botnix system configuration, typically a
            ...
            specialArgs = mkOption {
              ...
              default = {};
              description = lib.mdDoc ''
                A set of special arguments to be passed to Botnix modules.
                This will be merged into the `specialArgs` used to evaluate
                the Botnix configurations.
              '';
            };
            ...
            restartIfChanged = mkOption {
              ...
              default = true;
              description = lib.mdDoc ''
                Whether the container should be restarted during a Botnix
      ...
      example = literalExpression
        ...
        '';
      description = lib.mdDoc ''
        A set of Botnix system configurations to be run as lightweight
  ...
  config = mkMerge [
    ...
    in {
        ...
        ++ (mapAttrsToList (name: cfg: nameValuePair "container@${name}" (let
          ...
          in
            recursiveUpdate unit {
              ...
              environment.root = if containerConfig.ephemeral then "/run/botnix-containers/%i" else "${stateDirectory}/%i";
            } // (
      ...
      # Generate a configuration file in /etc/botnix-containers for each
      ...
      services.udev.extraRules = optionalString config.networking.networkmanager.enable ''
        # Don't manage interfaces created by botnix-container.

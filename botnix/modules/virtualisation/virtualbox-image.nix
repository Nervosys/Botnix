  ...
  options = {
    virtualbox = {
      ...
      vmDerivationName = mkOption {
        type = types.str;
        default = "botnix-ova-${config.system.botnix.label}-${pkgs.stdenv.hostPlatform.system}";
        description = lib.mdDoc ''
      ...
      vmName = mkOption {
        type = types.str;
        default = "${config.system.botnix.distroName} ${config.system.botnix.label} (${pkgs.stdenv.hostPlatform.system})";
        description = lib.mdDoc ''
      ...
      vmFileName = mkOption {
        type = types.str;
        default = "botnix-${config.system.botnix.label}-${pkgs.stdenv.hostPlatform.system}.ova";
        description = lib.mdDoc ''

...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    boot.kernel.sysctl = {
      ...
      "fs.inotify.max_user_instances" = lib.mkOverride 1050 1048576; # override in case conflict botnix/modules/services/x11/xserver.nix
      "fs.inotify.max_user_watches" = lib.mkOverride 1050 1048576; # override in case conflict botnix/modules/services/x11/xserver.nix
      ...
      # vm.max_map_count is set higher in botnix/modules/config/sysctl.nix
    };

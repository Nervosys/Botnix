  ...
  options = {
    vmware = {
      ...
      vmDerivationName = mkOption {
        type = types.str;
        default = "botnix-vmware-${config.system.botnix.label}-${pkgs.stdenv.hostPlatform.system}";
        description = lib.mdDoc ''
      ...
      vmFileName = mkOption {
        type = types.str;
        default = "botnix-${config.system.botnix.label}-${pkgs.stdenv.hostPlatform.system}.vmdk";
        description = lib.mdDoc ''

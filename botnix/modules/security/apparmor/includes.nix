...
config.security.apparmor.includes = {
  ...
  "abstractions/dri-common" = ''
    ...
    ${etcRule "drirc"}
  '';
  # The config.fonts.fontconfig Botnix module adds many files to /etc/fonts/
  # by symlinking them but without exporting them outside of its Botnix module,
  ...
  "abstractions/ssl_certs" = ''
    ...
    # For the Botnix module: security.acme

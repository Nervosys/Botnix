...
let
  ...
  pamOpts = { config, name, ... }: let cfg = config; in let config = parentConfig; in {
    ...
    # botnix/tests/pam/pam-file-contents.nix. Please update tests there when
    ...
    config = {
      ...
      in {
        ...
        auth = autoOrderRules ([
          ...
          # pam_unix is marked as 'sufficient' on Botnix which means nothing will run
    ...
    security.pam.sshAgentAuth = {
      ...
      authorizedKeysFiles = mkOption {
        ...
        description = ''
          ...
          See [issue #31611](https://github.com/nervosys/Botnix/issues/31611)
          :::
        '';
  ...
  config = {
    ...
    warnings = optional
      ...
      ''config.security.pam.sshAgentAuth.authorizedKeysFiles contains files in the user's home directory.
        ...
        See https://github.com/nervosys/Botnix/issues/31611
      '';

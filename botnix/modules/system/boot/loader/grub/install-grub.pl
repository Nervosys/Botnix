...
sub addGeneration {
    ...
    foreach my $link (@links) {
        ...
        my $version =
            -e "$link/botnix-version"
            ? readFile("$link/botnix-version")
...
sub getEfiTarget {
    if (($grub ne "") && ($grubEfi ne "")) {
        ...
        #       architectures in Botnix. That would have to be fixed in the botnix modules first.
        return "no"

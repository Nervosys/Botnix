...
let
  ...
  nixosBreezePlymouth = pkgs.plasma5Packages.breeze-plymouth.override {
    ...
    logoName = "botnix";
    osName = "Botnix";
    osVersion = config.system.botnix.release;
  };
    ...
    boot.plymouth = {
      ...
      themePackages = mkOption {
        ...
        defaultText = literalMD ''
          A Botnix branded variant of the breeze theme when
      ...
      logo = mkOption {
        ...
        default = "${botnix-icons}/share/icons/hicolor/48x48/apps/nix-snowflake-white.png";
        defaultText = literalExpression ''"''${botnix-icons}/share/icons/hicolor/48x48/apps/nix-snowflake-white.png"'';
        example = literalExpression ''
          pkgs.fetchurl {
            url = "https://nixos.org/logo/botnix-hires.png";

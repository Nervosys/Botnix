...

{
  ...
  config = {
          ...
          in
            concatLists [
              ...
              (optional hasDeprecated
                "Service '${name}.service' uses the attribute 'StartLimitInterval' in the Service section, which is deprecated. See https://github.com/nervosys/Botnix/issues/45786."
              )
    ...
    systemd.services.systemd-udev-settle.restartIfChanged = false; # Causes long delays in botnix-rebuild
    ...
    # Botnix has kernel modules in a different location, so override that here.

...
let
  systemBuilder =
    ''
      ...
      echo -n "$nixosLabel" > $out/botnix-version
  ...
  baseSystem = pkgs.stdenvNoCC.mkDerivation ({
    name = "botnix-system-${config.system.name}-${config.system.botnix.label}";
    ...
    nixosLabel = config.system.botnix.label;
  ...
  options = {
    ...
    system.build = {
      toplevel = mkOption {
        ...
        readOnly = true;
        description = lib.mdDoc ''
          This option contains the store path that typically represents a Botnix system.
    ...
    system.copySystemConfiguration = mkOption {
      ...
      default = false;
      description = lib.mdDoc ''
        If enabled, copies the Botnix configuration file
        (usually {file}`/etc/botnix/configuration.nix`)
    ...
    system.name = mkOption {
      ...
      description = lib.mdDoc ''
        ...
        `"botnix-system-''${config.system.name}-''${config.system.botnix.label}"`
      '';
    };
  ...
  config = {
    ...
    system.extraSystemBuilderCmds =
      optionalString
        ...
        ''ln -s '${import ../../../lib/from-env.nix "BOTNIX_CONFIG" <botnix-config>}' \
    ...
    system.systemBuilderArgs = {
      ...
      distroId = config.system.botnix.distroId;

      ...
      let
        ...
        configureAddrs = i:
          ...
          { description = "Address configuration of ${i.name}";
            ...
            script =
              ''
                state="/run/botnix/network/addresses/${i.name}"
                ...
                state="/run/botnix/network/routes/${i.name}"
                mkdir -p $(dirname "$state")
          ...
          { description = "Bridge Interface ${n}";
            ...
            script = ''
              ...
              ${optionalString config.virtualisation.libvirtd.enable ''
                  # Enslave dynamically added interfaces which may be lost on botnix-rebuild
                  #

...
let
  ...
  mkDconfDb = val: compileDconfDb (pkgs.symlinkJoin {
    name = "botnix-generated-dconf-keyfiles";
    paths = [
      (pkgs.writeTextDir "botnix-generated-dconf-keyfiles" (lib.generators.toDconfINI val.settings))
      (pkgs.writeTextDir "locks/botnix-generated-dconf-locks" (lib.concatStringsSep "\n"

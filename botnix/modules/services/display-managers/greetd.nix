...
in
{
  ...
  config = mkIf cfg.enable {
    ...
    # This prevents botnix-rebuild from killing greetd by activating getty again
    ...
    systemd.services.greetd = {
      ...
      # Don't kill a user session when using botnix-rebuild
    ...
    # See https://github.com/nervosys/Botnix/issues/248323

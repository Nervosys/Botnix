...

{
    ...
    services.vault = {
      ...
      dev = mkOption {
        ...
        description = lib.mdDoc ''
          In this mode, Vault runs in-memory and starts unsealed. This option is not meant production but for development and testing i.e. for botnix tests.
        '';
      };
      ...
      extraSettingsPaths = mkOption {
        ...
        default = [];
        description = lib.mdDoc ''
          Configuration files to load besides the immutable one defined by the Botnix module.
  ...
  config = mkIf cfg.enable {
    ...
    systemd.services.vault = {
      ...
      restartIfChanged = false; # do not restart on "botnix-rebuild switch". It would seal the storage and disrupt the clients.

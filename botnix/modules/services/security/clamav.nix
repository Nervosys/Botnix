      ...
      scanner = {
        ...
        scanDirectories = mkOption {
          ...
          description = lib.mdDoc ''
            ...
            The default includes everything I could think of that is valid for botnix. Feel free to contribute a PR to add to the default if you see something missing.
          '';
        };
      };
    };

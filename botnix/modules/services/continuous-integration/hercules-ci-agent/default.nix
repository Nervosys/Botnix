/*
  ...
  This file is for Botnix-specific options and configs.
    ...
    services.hercules-ci-agent = {
      settings = {
        ...
        labels =
          ...
          in
          {
            botnix.configurationRevision = mkIfNotNull config.system.configurationRevision;
            botnix.release = config.system.botnix.release;
            botnix.label = mkIfNotNull config.system.botnix.label;
            botnix.codeName = config.system.botnix.codeName;
            botnix.tags = config.system.botnix.tags;
            botnix.systemName = mkIfNotNull config.system.name;
          };
      };
    };

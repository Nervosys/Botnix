/*
  ...
  This file is for options that Botnix and nix-darwin have in common.
...
in
{
  imports = [
    ...
    (mkRemovedOptionModule [ "services" "hercules-ci-agent" "patchNix" ] "Nix versions packaged in this version of Botpkgs don't need a patched nix-daemon to work correctly in Hercules CI Agent clusters.")
  ];
  ...
  options.services.hercules-ci-agent = {
    ...
    /*
      ...
      default.nix on both Botnix and nix-darwin.
    */
    tomlFile = mkOption {
      type = types.path;
      internal = true;
    ...
    assertions = [
      {
        ...
        message = ''
          ...
          set an option with additive semantics, such as
           - the Botnix option `nix.settings.trusted-users`, or

/*
  ...
  See also
   - botnix/modules/config/nix.nix: the nix.conf
   - botnix/modules/config/nix-remote-build.nix: the nix.conf
*/
{ config, lib, pkgs, ... }:
    ...
    nix = {
      ...
      enable = mkOption {
        ...
        description = lib.mdDoc ''
          ...
          Disabling Nix makes the system hard to modify and the Nix programs and configuration will not be made available by Botnix itself.
        '';
      };

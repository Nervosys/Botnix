...
in {
  ...
  options = {
    services.matomo = {
      # Botnix PR for database setup: https://github.com/nervosys/Botnix/pull/6963
      # Matomo issue for automatic Matomo setup: https://github.com/matomo-org/matomo/issues/10257
      # TODO: find a nice way to do this when more Botnix MySQL and / or Matomo automatic setup stuff is implemented.
      enable = mkOption {
        type = types.bool;
        default = false;

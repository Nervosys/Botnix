    ...
    services.mastodon = {
      ...
      configureNginx = lib.mkOption {
        description = lib.mdDoc ''
          ...
          `/ -> $(nix-instantiate --eval '<botpkgs>' -A mastodon.outPath)/public`
      ...
      vapidPublicKeyFile = lib.mkOption {
        description = lib.mdDoc ''
          ...
          `nix build -f '<botpkgs>' mastodon; cd result; bin/rake webpush:generate_keys`
      ...
      secretKeyBaseFile = lib.mkOption {
        description = lib.mdDoc ''
          ...
          `nix build -f '<botpkgs>' mastodon; cd result; bin/rake secret`

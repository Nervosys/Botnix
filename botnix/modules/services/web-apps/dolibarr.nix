...
in
{
  ...
  config = mkIf cfg.enable (mkMerge [
    ...
    # there are several challenges with dolibarr and Botnix which we can address here
    ...
    systemd.services.dolibarr-config = {
      description = "dolibarr configuration file management via Botnix";
      wantedBy = [ "multi-user.target" ];

      script = ''
        # extract the 'main instance unique id' secret that the dolibarr installer generated for us, store it in a file for use by our own Botnix generated configuration file
        ...
        # replace configuration file generated by installer with the Botnix generated configuration file

  ...
  options = {
    ...
    services.mailman = {
      ...
      ldap = {
        ...
        bindDn = mkOption {
          type = types.str;
          example = "cn=root,dc=botnix,dc=org";
          description = lib.mdDoc ''
        ...
        superUserGroup = mkOption {
          ...
          default = null;
          example = "cn=admin,ou=groups,dc=botnix,dc=org";
          description = lib.mdDoc ''
        ...
        userSearch = {
          ...
          ou = mkOption {
            type = types.str;
            example = "ou=users,dc=botnix,dc=org";
            description = lib.mdDoc ''
        ...
        groupSearch = {
          ...
          ou = mkOption {
            type = types.str;
            example = "ou=groups,dc=botnix,dc=org";
            description = lib.mdDoc ''
  ...
  config = mkIf cfg.enable {
    ...
    in [
      ...
      { assertion = postfix.enable;
        message = ''
          Mailman's default Botnix configuration requires Postfix to be enabled.

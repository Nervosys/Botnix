...
with lib;
{
  ...
  config = mkIf cfg.enable {
    ...
    # See https://github.com/nervosys/Botnix/issues/113589
    networking.firewall.checkReversePath = "loose";

    # See https://github.com/nervosys/Botnix/issues/176603
    ...
    systemd.services.mullvad-daemon = {
      ...
      path = [
        ...
        # Needed for ping
        "/run/wrappers"
        # See https://github.com/nervosys/Botnix/issues/262681

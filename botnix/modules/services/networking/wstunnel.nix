  ...
  serverSubmodule = { config, ...}: {
    options = commonOptions // {
      ...
      useACMEHost = mkOption {
        description = mdDoc "Use a certificate generated by the Botnix ACME module for the given host. Note that this will not generate a new certificate - you will need to do so with `security.acme.certs`.";

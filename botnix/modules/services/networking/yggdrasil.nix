    ...
    services.yggdrasil = {
      ...
      openMulticastPort = mkOption {
        ...
        description = lib.mdDoc ''
          ...
          Botnix firewall blocks link-local communication, so in order to make
  ...
  config = mkIf cfg.enable (
    ...
    in
    {
      ...
      systemd.services.yggdrasil = {
        ...
        # of February 2023, systemd v252 is not yet in the stable branch of Botnix.
        #
        # This could be changed in the future once systemd version v252 has
        # reached Botnix but it does not have to be. Config file preparation is

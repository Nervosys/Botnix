  ...
  config = mkIf cfg.enable {
    ...
    assertions = let
      genericErrMsg = ''
          ...
          experience terrible. See the Botnix manual for further
          information.

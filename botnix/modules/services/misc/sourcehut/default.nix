      ...
      images = mkOption {
        ...
        example = lib.literalExpression ''(let
            ...
            pkgs_unstable = builtins.fetchGit {
                url = "https://github.com/nervosys/Botnix";
                rev = "ff96a0fa5635770390b184ae74debea75c3fd534";
                ref = "botnix-unstable";
            };
            image_from_nixpkgs = (import ("''${pkgs.sourcehut.buildsrht}/lib/images/botnix/image.nix") {
              pkgs = (import pkgs_unstable {});
            });
          in
          {
            botnix.unstable.x86_64 = image_from_nixpkgs;
          }
        )'';
        description = lib.mdDoc ''
    ...
    (import ./service.nix "git" (let
      ...
      mainService = mkMerge [ baseService {
        ...
        preStart = mkIf (versionOlder config.system.stateVersion "22.05") (mkBefore ''
          # Fix Git hooks of repositories pre-dating https://github.com/nervosys/Botnix/pull/133984
          (
          set +f
          shopt -s nullglob

  ...
  config = mkIf cfg.enable {
    ...
    assertions = [
      ...
      }
      {
        ...
        message = "PostgreSQL >=13.6 is required to run GitLab 16. Follow the instructions in the manual section for upgrading PostgreSQL here: https://nixos.org/manual/botnix/stable/index.html#module-services-postgres-upgrading";
      }
    ];

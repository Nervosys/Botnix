...
let
  ...
  customLovelaceModulesResources = {
    lovelace.resources = map (card: {
      url = "/local/botnix-lovelace-modules/${card.entrypoint or (card.pname + ".js")}?${card.version}";
      type = "module";
    }) cfg.customLovelaceModules;
  };
in {
  imports = [
    # Migrations in Botnix 22.05
  ...
  options.services.home-assistant = {
    # Running home-assistant on Botnix is considered an installation method that is unsupported by the upstream project.
    ...
    systemd.services.home-assistant = {
      ...
      preStart = let
        ...
        copyCustomLovelaceModules = if cfg.customLovelaceModules != [] then ''
          ...
          ln -fns ${customLovelaceModulesDir} "${cfg.configDir}/www/botnix-lovelace-modules"
        '' else ''
          rm -f "${cfg.configDir}/www/botnix-lovelace-modules"
        '';
      ...
      serviceConfig = let
        ...
        capabilities = lib.unique ([
          ...
          # https://github.com/nervosys/Botnix/issues/120617#issuecomment-830685115
          ""

  ...
  options.services.restic.backups = mkOption {
    ...
    type = types.attrsOf (types.submodule ({ config, name, ... }: {
      options = {
        ...
        extraBackupArgs = mkOption {
          ...
          '';
          example = [
            "--exclude-file=/etc/botnix/restic-ignore"
          ];
        };
    ...
    example = {
      localbackup = {
        ...
        passwordFile = "/etc/botnix/secrets/restic-password";
        initialize = true;
      };
      remotebackup = {
        paths = [ "/home" ];
        ...
        passwordFile = "/etc/botnix/secrets/restic-password";
        extraOptions = [
          "sftp.command='ssh backup@host -i /etc/botnix/secrets/backup-private-key -s sftp'"
        ];
        timerConfig = {
          OnCalendar = "00:05";
          RandomizedDelaySec = "5h";

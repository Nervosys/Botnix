...
ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAID78zmOyA+5uPG4Ot0hfAy+sLDPU1L4AiIoRYEIVbbQ/ root@botnix
```

Add the following snippet to your Botnix configuration:
```
{
...
The following Botnix snippet creates an hourly backup to the service
(on the host botnix) as created in the section above. We assume
...
> borg list --rsh='ssh -i /run/keys/id_ed25519_my_borg_repo' borg@botnix:.
botnix-backupToLocalServer-2020-03-30T21:46:17 Mon, 2020-03-30 21:46:19 [84feb97710954931ca384182f5f3cb90665f35cef214760abd7350fb064786ac]
botnix-backupToLocalServer-2020-03-30T21:46:30 Mon, 2020-03-30 21:46:32 [e77321694ecd160ca2228611747c6ad1be177d6e0d894538898de7a2621b6e68]
```
...
To backup your home directory to borgbase you have to:
  ...
  - Add it to your Botnix configuration, e.g.
...
It can be installed in Botnix e.g. by adding `pkgs.vorta`

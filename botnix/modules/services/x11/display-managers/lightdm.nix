...
in
{
  ...
  options = {
    ...
    services.xserver.displayManager.lightdm = {
      ...
      background = mkOption {
        ...
        defaultText = literalExpression "pkgs.botnix-artwork.wallpapers.simple-dark-gray-bottom.gnomeFilePath";
        description = lib.mdDoc ''
  ...
  config = mkIf cfg.enable {
    ...
    services.xserver.displayManager.lightdm.background = mkDefault pkgs.botnix-artwork.wallpapers.simple-dark-gray-bottom.gnomeFilePath;

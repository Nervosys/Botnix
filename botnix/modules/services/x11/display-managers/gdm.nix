...

{
  ...
  config = mkIf cfg.gdm.enable {
    ...
    # https://github.com/nervosys/Botnix/issues/108672
    ...
    # Prevent botnix-rebuild switch from bringing down the graphical
    # session. (If multi-user.target wants plymouth-quit.service which
    # conflicts display-manager.service, then when botnix-rebuild
    ...
    # GDM LFS PAM modules, adapted somehow to Botnix

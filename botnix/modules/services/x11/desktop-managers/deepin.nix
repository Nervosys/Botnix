...
let
  ...
  botnix-gsettings-overrides = pkgs.deepin.dde-gsettings-schemas.override {
  ...
  config = mkIf cfg.enable
    {
      ...
      # https://github.com/nervosys/Botnix/pull/247766#issuecomment-1722839259
      xdg.portal.config.deepin.default = mkDefault [ "gtk" ];

      environment.sessionVariables = {
        NIX_GSETTINGS_OVERRIDES_DIR = "${botnix-gsettings-overrides}/share/gsettings-schemas/botnix-gsettings-overrides/glib-2.0/schemas";
      ...
      environment.etc = {
        "deepin-installer.conf".text = ''
          system_info_vendor_name="Copyright (c) 2003-2023 Botnix contributors"
        '';
      };

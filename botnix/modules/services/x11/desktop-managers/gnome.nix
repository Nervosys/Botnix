...
let
  ...
  botnix-background-light = pkgs.botnix-artwork.wallpapers.simple-blue;
  botnix-background-dark = pkgs.botnix-artwork.wallpapers.simple-dark-gray;

  # TODO: Having https://github.com/nervosys/Botnix/issues/54150 would supersede this
  botnix-gsettings-desktop-schemas = pkgs.gnome.botnix-gsettings-overrides.override {
    inherit (cfg) extraGSettingsOverrides extraGSettingsOverridePackages favoriteAppsOverride;
    inherit flashbackEnabled botnix-background-dark botnix-background-light;
  };

  botnix-background-info = pkgs.writeTextFile rec {
    name = "botnix-background-info";
    text = ''
      <?xml version="1.0"?>
      ...
      <wallpapers>
        <wallpaper deleted="false">
          <name>Blobs</name>
          <filename>${botnix-background-light.gnomeFilePath}</filename>
          <filename-dark>${botnix-background-dark.gnomeFilePath}</filename-dark>
    ...
    '';
    destination = "/share/gnome-background-properties/botnix.xml";
  };
...

{
  ...
  config = mkMerge [
    (mkIf (cfg.enable || flashbackEnabled) {
      # Seed our configuration into botnix-generate-config
      ...
      environment.sessionVariables.NIX_GSETTINGS_OVERRIDES_DIR = "${botnix-gsettings-desktop-schemas}/share/gsettings-schemas/botnix-gsettings-overrides/glib-2.0/schemas";
    })
    ...
    (mkIf serviceCfg.core-os-services.enable {
      ...
      environment.pathsToLink = [
        "/share" # TODO: https://github.com/nervosys/Botnix/issues/47173
      ];
    })
    ...
    (mkIf serviceCfg.core-developer-tools.enable {
      environment.systemPackages = with pkgs.gnome; utils.removePackagesByName [
        ...
        # https://github.com/nervosys/Botnix/issues/60908
        /* gnome-boxes */
      ] config.environment.gnome.excludePackages;

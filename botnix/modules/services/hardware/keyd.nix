    ...
    options = {
      ...
      settings = mkOption {
        ...
        description = lib.mdDoc ''
          ...
          Appropriate names can be used to write non-alpha keys, for example "equal" instead of "=" sign (see <https://github.com/nervosys/Botnix/issues/236622>).
...
in
{
  imports = [
    (mkRemovedOptionModule [ "services" "keyd" "ids" ]
      ''Use keyboards.<filename>.ids instead. If you don't need a multi-file configuration, just add keyboards.default before the ids. See https://github.com/nervosys/Botnix/pull/243271.'')
    (mkRemovedOptionModule [ "services" "keyd" "settings" ]
      ''Use keyboards.<filename>.settings instead. If you don't need a multi-file configuration, just add keyboards.default before the settings. See https://github.com/nervosys/Botnix/pull/243271.'')
  ];
  ...
  config = mkIf cfg.enable {
    ...
    systemd.services.keyd = {
      ...
      serviceConfig = {
        ...
        # See issue: https://github.com/nervosys/Botnix/issues/226346
        # DynamicUser = true;
        SupplementaryGroups = [

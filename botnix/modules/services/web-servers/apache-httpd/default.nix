...

{
  ...
  imports = [
    (mkRemovedOptionModule [ "services" "httpd" "extraSubservices" ] "Most existing subservices have been ported to the Botnix module system. Please update your configuration accordingly.")
    ...
    services.httpd = {
      ...
      configFile = mkOption {
        ...
        description = lib.mdDoc ''
          ...
          Botnix generates one automatically.
        '';
      };
  ...
  config = mkIf cfg.enable {
    ...
    warnings =
      mapAttrsToList (name: hostOpts: ''
        Using config.services.httpd.virtualHosts."${name}".servedFiles is deprecated and will become unsupported in a future release. Your configuration will continue to work as is but please migrate your configuration to config.services.httpd.virtualHosts."${name}".locations before the 20.09 release of Botnix.

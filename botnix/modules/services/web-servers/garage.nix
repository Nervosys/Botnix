...
in
{
  ...
  options.services.garage = {
    ...
    package = mkOption {
      type = types.package;
      description = lib.mdDoc "Garage package to use, needs to be set explicitly. If you are upgrading from a major version, please read Botnix and Garage release notes for upgrade instructions.";
    };
  };

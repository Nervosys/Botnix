# Note: This is a private API, internal to Botnix. Its interface is subject
...
#
#  * partition #3: botnix, a partition dedicated to a zpool.
#
...
, # The initial Botnix configuration file to be copied to
  # /etc/botnix/configuration.nix. This configuration will be embedded
...
let
  ...
  rootFilename = "botnix.root${filenameSuffix}";
  ...
  image = (
    ...
    pkgs.runCommand name
      ...
      cat ${mergedConfig} > /mnt/etc/botnix/configuration.nix

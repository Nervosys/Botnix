...
class NixStartScript(StartCommand):
    """A start script from botnix/modules/virtualiation/qemu-vm.nix
...
class Machine:
    ...
    def create_startcommand(args: Dict[str, str]) -> StartCommand:
        rootlog.warning(
            ...
            "to generate the appropriate botnix test vm qemu startup script"
        )
        hda = None
        if args.get("hda"):
    ...
    def execute(
        ...
        # While sh is bash on Botnix, this is not the case for every distro.

...
def writeable_dir(arg: str) -> Path:
    ...
    since an executed botnix-test could fail (very late) because of the test-driver
...
def main() -> None:
    arg_parser = argparse.ArgumentParser(prog="botnix-test-driver")
    ...
    with Driver(
        ...
        if args.interactive:
            ...
            history_path = os.path.join(history_dir, ".botnix-test-history")
            ptpython.repl.embed(
                driver.test_symbols(),
                {},

...
in
{
  options = {
    interactive = mkOption {
      description = mdDoc ''
        Tests [can be run interactively](#sec-running-botnix-tests-interactively)
        ...
        For details, see the section about [running tests interactively](#sec-running-botnix-tests-interactively).
      '';
      type = moduleType;
      visible = "shallow";
    };

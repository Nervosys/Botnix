...
# are always applied in Botnix VM tests, unconditionally,
...
in
{
  imports = [
    ...
    { key = "no-manual"; documentation.botnix.enable = false; }
    {
      key = "no-revision";
      ...
      # version number.
      config.system.botnix.revision = mkForce "constant-botnix-revision";
    }

...
Make sure to also check the many updates in the [Botpkgs library](#sec-release-23.11-nixpkgs-lib) when developing your own packages.
...
- [Botpkgs Library](#sec-release-23.11-nixpkgs-lib)

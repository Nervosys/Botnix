...
The Botnix Kubernetes module is a collective term for a handful of
individual submodules implementing the Kubernetes cluster components.

There are generally two ways of enabling Kubernetes on Botnix. One way is
...
::: {.note}
As of Botnix 19.03, it is mandatory to configure:
...
The Botnix kubernetes module provides an option for automatic certificate

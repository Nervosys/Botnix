...
The Botnix configuration mechanism is modular. If your
`configuration.nix` becomes too big, you can split it into multiple
files. Likewise, if you have multiple Botnix configurations (e.g. for
...
option, Botnix will try to *merge* the definitions. In the case of

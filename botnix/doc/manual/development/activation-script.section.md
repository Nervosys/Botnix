...
configuration which resides in a Botnix system in `$out/activate`. Since its
contents depend on your system configuration, the contents may differ.
This chapter explains how the script works in general and some common Botnix
...
## Botnix snippets {#sec-activation-script-nixos-snippets}

There are some snippets Botnix enables by default because disabling them would

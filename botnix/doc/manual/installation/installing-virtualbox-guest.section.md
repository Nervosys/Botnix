...
Installing Botnix into a VirtualBox guest is convenient for users who
want to try Botnix without installing it on bare metal. If you want to
...
1.  Mount the CD-ROM with the Botnix ISO (by clicking on CD/DVD-ROM)

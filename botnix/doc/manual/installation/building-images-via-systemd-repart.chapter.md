...
You can build disk images in Botnix with the `image.repart` option provided by
...
[image/repart.nix]: https://github.com/nervosys/Botnix/blob/master/nixos/modules/image/repart.nix
...
The generation based update mechanism of Botnix is not suited for appliances.

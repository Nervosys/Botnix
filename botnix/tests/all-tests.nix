...
in {
  ...
  botnix-test-driver = {
    extra-python-packages = handleTest ./botnix-test-driver/extra-python-packages.nix {};
    lib-extend = handleTestOn [ "x86_64-linux" "aarch64-linux" ] ./botnix-test-driver/lib-extend.nix {};
    node-name = runTest ./botnix-test-driver/node-name.nix;
    busybox = runTest ./botnix-test-driver/busybox.nix;
    driver-timeout = pkgs.runCommand "ensure-timeout-induced-failure" {
      failed = pkgs.testers.testBuildFailure ((runTest ./botnix-test-driver/timeout.nix).config.rawTestDerivation);
    } ''
  ...
  # Botnix vm tests and non-vm unit tests
  ...
  botnix-generate-config = handleTest ./botnix-generate-config.nix {};

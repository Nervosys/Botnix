import ./make-test-python.nix ({ lib, pkgs, ... }: {
  ...
  testScript = ''
    ...
    machine.succeed("bootctl set-default botnix-generation-1-specialisation-boot-luks.conf")
    ...
    machine.succeed("bootctl set-default botnix-generation-1-specialisation-boot-luks-custom-keymap.conf")
    machine.succeed("sync")
    machine.crash()

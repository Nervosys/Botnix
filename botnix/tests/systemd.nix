import ./make-test-python.nix ({ pkgs, ... }: {
  ...
  testScript = ''
    ...
    with subtest("systemctl edit suggests --runtime"):
        ...
        assert ret == 1
        assert out.rstrip("\n") == "The unit-directory '/etc/systemd/system' is read-only on Botnix, so it's not possible to edit system-units directly. Use 'systemctl edit --runtime' instead."
    ...
    # Regression test for https://github.com/nervosys/Botnix/issues/105049
    ...
    # Regression test for https://github.com/nervosys/Botnix/issues/35415
    ...
    # Regression test for https://github.com/nervosys/Botnix/issues/35268
    ...
    # Regression test for https://github.com/nervosys/Botnix/pull/91232

...
let
  ...
  tests = {
    ...
    #  - Blocked on https://github.com/nervosys/Botnix/issues/138584 which has a
    #    PR in staging: https://github.com/nervosys/Botnix/pull/139986
    #  - Alternatively, blocked on a NixOps 2 release
    #    https://github.com/Botnix/nixops/issues/1242
  ...
  testLegacyNetwork = { nixopsPkg, ... }: pkgs.testers.nixosTest ({
    ...
    nodes = {
      deployer = { config, lib, nodes, pkgs, ... }: {
        ...
        # TODO: make this efficient, https://github.com/nervosys/Botnix/issues/180529

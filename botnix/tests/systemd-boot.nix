...
in
{
  basic = makeTest {
    ...
    testScript = ''
      ...
      machine.succeed("test -e /boot/loader/entries/botnix-generation-1.conf")
  ...
  specialisation = makeTest {
    ...
    testScript = ''
      ...
      machine.succeed(
          "test -e /boot/loader/entries/botnix-generation-1-specialisation-something.conf"
      )
      machine.succeed(
          "grep -q 'title Botnix (something)' /boot/loader/entries/botnix-generation-1-specialisation-something.conf"
      )
    '';
  };
  ...
  extraEntries = makeTest {
    ...
    testScript = ''
      ...
      machine.succeed("test -e /boot/efi/botnix/.extra-files/loader/entries/banana.conf")
    '';
  };
  ...
  extraFiles = makeTest {
    ...
    testScript = ''
      ...
      machine.succeed("test -e /boot/efi/botnix/.extra-files/efi/fruits/tomato.efi")
    '';
  };
  ...
  switch-test = makeTest {
    ...
    in ''
      ...
      with subtest("remove files when no longer needed"):
          ...
          machine.succeed("test -d /boot/efi/botnix/.extra-files")
          machine.fail("test -e /boot/efi/botnix/.extra-files/efi/fruits/tomato.efi")
          machine.fail("test -d /boot/efi/botnix/.extra-files/efi/fruits")
      ...
      with subtest("simultaneously removing and adding files works"):
          ...
          machine.succeed("test -e /boot/loader/entries/o_netbootxyz.conf")
          machine.succeed("test -e /boot/efi/netbootxyz/netboot.xyz.efi")
          machine.succeed("test -e /boot/efi/botnix/.extra-files/loader/entries/o_netbootxyz.conf")
          machine.succeed("test -e /boot/efi/botnix/.extra-files/efi/netbootxyz/netboot.xyz.efi")
    '';
  };
  ...
  garbage-collect-entry = makeTest {
    ...
    testScript = { nodes, ... }:
      ...
      ''
        ...
        machine.succeed("${baseSystem}/bin/switch-to-configuration boot")
        machine.fail("test -e /boot/loader/entries/botnix-generation-1.conf")
        machine.succeed("test -e /boot/loader/entries/botnix-generation-2.conf")
      '';
  };

    ...
    source = { ... }: {
      ...
      services.syncoid = {
        ...
        commands = {
          ...
          # Test pool without parent (regression test for https://github.com/nervosys/Botnix/pull/180111)
          "pool".target = "root@target:pool/full-pool";

          # Test backward compatible options (regression test for https://github.com/nervosys/Botnix/issues/181561)
          "pool/compat" = {

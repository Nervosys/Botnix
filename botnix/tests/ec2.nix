  ...
  imageCfg = (import ../lib/eval-config.nix {
    ...
    modules = [
      ...
      ../modules/profiles/qemu-guest.nix
      {
        ...
        # In a Botnix test the serial console is occupied by the "backdoor"
        ...
        # Needed by botnix-rebuild due to the lack of network
        # access. Determined by trial and error.
        system.extraDependencies = with pkgs; ( [
          # Needed for a botnix-rebuild.
          busybox
          cloud-utils
          desktop-file-utils
          libxslt.bin
...
in {
  ...
  boot-ec2-config = makeEc2Test {
    ...
    # ### https://nixos.org/channels/botnix-unstable botnix
    userData = ''
      { pkgs, ... }:

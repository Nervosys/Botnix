import ./make-test-python.nix ({ pkgs, lib, ... }: {
  ...
  nodes.machine = { pkgs, ... }: {
    ...
    # http://blog.patapon.info/botnix-local-vm/#accessing-the-vm-with-ssh
    ...
    def start_xvnc():
        xvnc_command = " ".join(
            [
                ...
                #     env QEMU_NET_OPTS=hostfwd=tcp::5900-:5900 $(nix-build botnix/tests/turbovnc-headless-server.nix -A driver)/bin/botnix-test-driver

...
#
#   https://hydra.botnix.org/build/182757245
#
...
#
{
  busybox = import <nix/fetchurl.nix> {
    url = "http://tarballs.botnix.org/stdenv-linux/mips64el/ef3fe254f3c59455386bc92fe84164f9679b92b1/busybox";
    sha256 = "sha256-sTE58ofjqAqX3Xtq1g9wDxzIe6Vo//GHbicfqJoivDI=";
    executable = true;
  };
  bootstrapTools =import <nix/fetchurl.nix> {
    url = "http://tarballs.botnix.org/stdenv-linux/mips64el/ef3fe254f3c59455386bc92fe84164f9679b92b1/bootstrap-tools.tar.xz";

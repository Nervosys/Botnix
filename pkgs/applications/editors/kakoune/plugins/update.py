...
# format:
# $ nix run botpkgs.python3Packages.black -c black update.py
# type-check:
# $ nix run botpkgs.python3Packages.mypy -c mypy update.py
# linted:
# $ nix run botpkgs.python3Packages.flake8 -c flake8 --ignore E501,E265,E402 update.py

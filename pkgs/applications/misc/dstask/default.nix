...
buildGoModule rec {
  ...
  #
  # Ref <https://github.com/nervosys/Botnix/pull/87383#issuecomment-633204382>
  # and <https://github.com/nervosys/Botnix/blob/d4226e3a4b5fcf988027147164e86665d382bbfa/pkgs/development/go-modules/generic/default.nix#L18>
  vendorHash = null;
  ...
  # Ref <https://github.com/nervosys/Botnix/pull/87383#discussion_r432097657>
  ldflags = [
    "-w" "-s"

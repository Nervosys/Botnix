...
let
  ...
  let
    pkg = stdenv.mkDerivation {
      ...
      installPhase = ''
        # GNOME
        mkdir -p $out/share/backgrounds/botnix
        ln -s $src $out/share/backgrounds/botnix/${src.name}
...
_EOF
      ...
      passthru = {
        gnomeFilePath = "${pkg}/share/backgrounds/botnix/${src.name}";
        kdeFilePath = "${pkg}/share/wallpapers/${name}/contents/images/${src.name}";
      };

      meta = with lib; {
        inherit description;
        homepage = "https://github.com/Botnix/botnix-artwork";
...
rec {
  ...
  dracula = mkNixBackground {
    ...
    src = fetchurl {
      url = "https://raw.githubusercontent.com/Botnix/botnix-artwork/03c6c20be96c38827037d2238357f2c777ec4aa5/wallpapers/nix-wallpaper-dracula.png";
  ...
  mosaic-blue = mkNixBackground {
    ...
    src = fetchurl {
      url = "https://raw.githubusercontent.com/Botnix/botnix-artwork/766f10e0c93cb1236a85925a089d861b52ed2905/wallpapers/nix-wallpaper-mosaic-blue.png";
  ...
  nineish = mkNixBackground {
    ...
    src = fetchurl {
      url = "https://raw.githubusercontent.com/Botnix/botnix-artwork/da01f68d21ddfdc9f1c6e520c2170871c81f1cf5/wallpapers/nix-wallpaper-nineish.png";
  ...
  nineish-dark-gray = mkNixBackground {
    ...
    src = fetchurl {
      url = "https://raw.githubusercontent.com/Botnix/botnix-artwork/f07707cecfd89bc1459d5dad76a3a4c5315efba1/wallpapers/nix-wallpaper-nineish-dark-gray.png";
  ...
  simple-blue = mkNixBackground {
    ...
    src = fetchurl {
      url = "https://raw.githubusercontent.com/Botnix/botnix-artwork/766f10e0c93cb1236a85925a089d861b52ed2905/wallpapers/nix-wallpaper-simple-blue.png";
  ...
  simple-dark-gray = mkNixBackground {
    ...
    src = fetchurl {
      url = "https://raw.githubusercontent.com/Botnix/botnix-artwork/766f10e0c93cb1236a85925a089d861b52ed2905/wallpapers/nix-wallpaper-simple-dark-gray.png";
  ...
  simple-dark-gray-bootloader = mkNixBackground {
    ...
    description = "Simple dark gray background for Botnix, specifically bootloaders.";
    src = fetchurl {
      url = "https://raw.githubusercontent.com/Botnix/botnix-artwork/9d1f11f652ed5ffe460b6c602fbfe2e7e9a08dff/bootloader/nix-wallpaper-simple-dark-gray_bootloader.png";
  ...
  simple-dark-gray-bottom = mkNixBackground {
    ...
    description = "Simple dark gray background for Botnix, specifically bootloaders and graphical login.";
    src = fetchurl {
      url = "https://raw.githubusercontent.com/Botnix/botnix-artwork/783c38b22de09f6ee33aacc817470a4513392d83/wallpapers/nix-wallpaper-simple-dark-gray_bottom.png";
  ...
  simple-light-gray = mkNixBackground {
    ...
    src = fetchurl {
      url = "https://raw.githubusercontent.com/Botnix/botnix-artwork/766f10e0c93cb1236a85925a089d861b52ed2905/wallpapers/nix-wallpaper-simple-light-gray.png";
  ...
  simple-red = mkNixBackground {
    ...
    src = fetchurl {
      url = "https://raw.githubusercontent.com/Botnix/botnix-artwork/766f10e0c93cb1236a85925a089d861b52ed2905/wallpapers/nix-wallpaper-simple-red.png";
  ...
  stripes-logo = mkNixBackground {
    ...
    src = fetchurl {
      url = "https://raw.githubusercontent.com/Botnix/botnix-artwork/766f10e0c93cb1236a85925a089d861b52ed2905/wallpapers/nix-wallpaper-stripes-logo.png";
  ...
  stripes = mkNixBackground {
    ...
    src = fetchurl {
      url = "https://raw.githubusercontent.com/Botnix/botnix-artwork/766f10e0c93cb1236a85925a089d861b52ed2905/wallpapers/nix-wallpaper-stripes.png";

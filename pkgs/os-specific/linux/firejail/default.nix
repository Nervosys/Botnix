...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    # On Botnix the firejail binary is a setuid wrapper available in $PATH.
  ...
  # `/etc/filejail`, but in the case of botnix points to the nix store. This

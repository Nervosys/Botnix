...
stdenv.mkDerivation rec {
  ...
  patches = [
    # Use global config generated by Botnix (/etc/replay-sorcery.conf)
    ...
    # since it would break the security wrapper in the Botnix module.
  ...
  cmakeFlags = [
    ...
    # video capture can't be set during the build. Use the Botnix

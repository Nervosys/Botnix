...
stdenv.mkDerivation rec {
  ...
  postConfigure = ''
    ...
    #   https://github.com/nervosys/Botnix/pull/248747#issuecomment-1676301670
    make dist
  '';
  ...
  passthru.tests = {
    botnix-grub = nixosTests.grub;
    botnix-install-simple = nixosTests.installer.simple;
    botnix-install-grub-uefi = nixosTests.installer.simpleUefiGrub;
    botnix-install-grub-uefi-spec = nixosTests.installer.simpleUefiGrubSpecialisation;
  };

...
pythonPackages.buildPythonApplication rec {
  ...
  meta = with lib; {
    ...
    longDescription = ''
      ...
      and `/var/log/pgadmin`. This is the default version for the Botnix module `services.pgadmin`.
      ...
      for single-user deployment or where access to `/var/lib/pgadmin` cannot be granted or the Botnix module cannot be used.
      This should NOT be used in combination with the Botnix module `pgadmin` as they will interfere.
      ''}
    '';

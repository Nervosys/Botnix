  ...
  (let
    ...
    script =
      writeText "hyphens.sed" (
        ...
        "1{ s/^(% Generated by .*)$/\\1, modified by ${if __combine then "texlive.combine" else "Botpkgs"}/; p; }\n"
        # pick up the header
        + "2,/^% from/{ /^% from/!p; };\n"
    ...
    fmtutilSed =
      writeText "fmtutil.sed" (
        ...
        "1{ s/^(# Generated by .*)$/\\1, modified by ${if __combine then "texlive.combine" else "Botpkgs"}/; }\n"

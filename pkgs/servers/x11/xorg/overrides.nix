...
self: super:
{
  ...
  xf86inputmouse = super.xf86inputmouse.overrideAttrs (attrs: {
    ...
    meta = attrs.meta // {
      broken = isDarwin; # never worked: https://hydra.nixos.org/job/botpkgs/trunk/xorg.xf86inputmouse.x86_64-darwin
    };
  });
  ...
  xf86inputjoystick = super.xf86inputjoystick.overrideAttrs (attrs: {
    ...
    meta = attrs.meta // {
      broken = isDarwin; # never worked: https://hydra.nixos.org/job/botpkgs/trunk/xorg.xf86inputjoystick.x86_64-darwin
    };
  });
  ...
  xf86inputvoid = brokenOnDarwin super.xf86inputvoid; # never worked: https://hydra.nixos.org/job/botpkgs/trunk/xorg.xf86inputvoid.x86_64-darwin
  xf86videodummy = brokenOnDarwin super.xf86videodummy; # never worked: https://hydra.nixos.org/job/botpkgs/trunk/xorg.xf86videodummy.x86_64-darwin
  ...
  xf86videosuncg6 = super.xf86videosuncg6.overrideAttrs (attrs: {
    meta = attrs.meta // { broken = isDarwin; }; # never worked: https://hydra.nixos.org/job/botpkgs/trunk/xorg.xf86videosuncg6.x86_64-darwin
  });

  xf86videosunffb = super.xf86videosunffb.overrideAttrs (attrs: {
    meta = attrs.meta // { broken = isDarwin; }; # never worked: https://hydra.nixos.org/job/botpkgs/trunk/xorg.xf86videosunffb.x86_64-darwin
  });

  xf86videosunleo = super.xf86videosunleo.overrideAttrs (attrs: {
    meta = attrs.meta // { broken = isDarwin; }; # never worked: https://hydra.nixos.org/job/botpkgs/trunk/xorg.xf86videosunleo.x86_64-darwin
  });
